...
def clean_events():
    ...
    geo1_ind = events.query('geoeff == 1')
    geo2_ind = events.query('geoeff == 2')
    geo3_ind = events.query('geoeff == 3')
    geo9_ind = events.query('geoeff == 9')
    

    #save the cleaned up dataset   
    pickle.dump(events_time_frac,open("train/events_time_frac_fitall3_train_dst80_kp6_clean.p", "wb"))
    pickle.dump(events,open("train/events_fitall3_train_dst80_kp6_clean.p", "wb"))
